...
class sekwencja_MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Odbierz wartości correctCount i wrongCount, jeśli zostały przekazane z poprzedniej aktywności
        ...
        // Wylosuj indeks przycisku z poprawną odpowiedzią
        ...
        for (buttonId in allButtonIds) {
            ...
            if (button == randomButton) {
                ...
                button.setOnClickListener {
                    ...
                    intent2.putExtra("CORRECT_COUNT", correctCount)
                    intent2.putExtra("WRONG_COUNT", wrongCount)
